package java.com.trip.global.util;
...
import java.com.trip.user.dto.CustomUserInfoDto;
...
public class JwtUtil {
     ...
     */
    public String createAccessToken(CustomUserInfoDto user, String jti, String familyId) { return createToken(user, jti, familyId, ACCESS_TOKEN_EXP_TIME); }
