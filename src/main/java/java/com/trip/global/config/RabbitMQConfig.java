...
public class RabbitMQConfig {
    ...
    /**
     * connectionFactory: RabbitMQ와의 연결을 효율적으로 관리하기 위해 커넥션 풀링 및 캐싱 기능을 제공
     *
    ...
    public RabbitTemplate rabbitTemplate(ConnectionFactory connectionFactory,
        ...
        RabbitTemplate rabbitTemplate = new RabbitTemplate(connectionFactory); // RabbitTemplate이 사용할 연결 팩토리를 지정
